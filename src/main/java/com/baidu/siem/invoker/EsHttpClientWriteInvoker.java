...
import com.baidu.siem.threadpool.EsHttpClientTask;
 ...
 */
public class EsHttpClientWriteInvoker extends AbstractInvoker {
    ...
    public EsHttpClientWriteInvoker(EsThrottle esSearchThrottle, String url, String targetNode, HttpServletRequest request) {
        this(esSearchThrottle, url, "", 3000, "true", targetNode, request);
    }

    public EsHttpClientWriteInvoker(EsThrottle esSearchThrottle, String url, String requestData, long timeout, String sync, String targetNode, HttpServletRequest request) {
        this(esSearchThrottle, url, requestData, timeout, sync, new Response(), new ConcurrentHashMap<String, String>(), targetNode, request);
    }

    public EsHttpClientWriteInvoker(EsThrottle esSearchThrottle, String url, String requestData, long timeout, String sync, Response response, Map<String, String> parameters, String targetNode, HttpServletRequest request) {
